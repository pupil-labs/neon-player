"""
This module provides a method `bg_export_video` for exporting a video
...
The plugin that uses this method needs to implement and provide a render method
...
def _prepare_timestamps(
    ...
    for gap in reversed(gaps):
        ...
        gap_timestamps = np.arange(gap_start, gap_end, 1e9 // fps, dtype=np.int64)
        combined_timestamps = np.concatenate((
